...
SAFETY_MODULES: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "test_set_config_compaction.py": (
        ...
        (
            ...
            "test_a_context_too_small_for_the_contract_is_fail_loud",
            "test_a_state_file_for_another_config_is_refused",
            "test_restore_last_backup_puts_the_ownership_record_back",
            "test_the_plugin_accepts_exactly_what_set_config_wrote",
            "test_a_symlinked_state_file_is_refused",
            "test_a_symlinked_state_directory_is_refused",
            "test_the_state_directory_ends_up_owner_only",
            "test_a_project_scoped_config_never_gets_the_plugin_path",
            "test_restore_reports_failure_when_a_backup_is_missing",
            "test_restore_still_works_for_a_symlinked_opencode_config",
            ...
            "test_restore_puts_the_state_file_back_owner_only",
            "test_restore_refuses_when_a_symlinked_config_was_repointed",
            "test_a_manifest_that_cannot_be_written_does_not_survive_stale",
            "test_a_compaction_agent_model_without_limits_is_fail_loud",
            "test_the_writer_derives_from_the_compaction_agent_model",
    ...
    "test_opencode_compaction_plugin.py": (
        ...
        (
            ...
            "test_state_digest_agrees_across_languages",
            "test_plugin_rejects_a_tampered_state",
            "test_verify_detects_blank_and_reasoning_only_summaries",
            "test_verify_detects_the_user_before_compaction_race",
            "test_verify_detects_the_compaction_before_user_race",
            ...
            "test_a_pending_question_is_never_compacted",
            "test_a_tool_call_step_is_not_a_completed_answer",
            "test_an_attachment_only_user_is_a_real_question",
            "test_reconciliation_selects_turns_by_parent_not_by_position",
            "test_child_sessions_get_no_reconciliation",
            "test_sub_sessions_are_never_compacted",
            "test_error_and_aborted_turns_are_never_compacted",
            "test_repeated_idle_events_compact_at_most_once",
            "test_concurrent_idle_events_still_compact_at_most_once",
            ...
            "test_application_log_and_incident_are_content_free",
            "test_the_plugin_never_rejects_when_every_client_call_fails",
            "test_manual_compact_is_verified_too",
            "test_every_hook_goes_through_the_same_gate",
            "test_a_stale_tail_budget_is_reported_not_silently_used",
            "test_native_with_a_pre_existing_plugin_stays_silent",
            "test_the_session_map_stays_bounded_even_when_every_entry_is_stopped",
            "test_config_identity_needs_both_hashes_in_js_too",
            "test_a_landed_compaction_is_verified_even_when_the_gate_would_stop",
            "test_the_compaction_agent_model_drives_the_recomputation",
            "test_a_bigger_compaction_model_does_not_raise_the_main_model_threshold",
            "test_manual_mode_also_reports_a_stale_tail_budget",
            "test_an_sdk_error_response_is_not_treated_as_drift",
            "test_a_compaction_that_started_under_a_failing_gate_is_still_verified",
            "test_two_interleaved_compactions_are_both_verified",
            "test_a_stopped_session_stays_stopped_after_its_entry_is_evicted",
            "test_native_or_unmanaged_never_verifies_a_manual_compact",
            "test_two_compactions_are_both_verified_even_when_one_lands_first",
            "test_derive_settings_accepts_json_integral_floats",
            "test_a_summary_still_streaming_is_not_a_failure",
    ...
    "test_session_eval.py": (
        ...
        (
            ...
            "test_replay_config_denies_every_mutating_tool",
            ...
            "test_replay_config_drops_the_managed_compaction_override",
