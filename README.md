...
以下範例用 5090 32GB + 170GB RAM + Qwen3-235B-A22B-Thinking-2507 UD-Q4_K_XL(`--n-cpu-moe N --no-mmap`,N 依 VRAM 調整見 。若你硬體 / 模型是正規 pure GPU,  將 `--n-cpu-moe` 與 `--no-mmap` 兩行拿掉即可。
