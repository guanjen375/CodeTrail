...
互動式模式（`--chat`、`--image`、`--url`）會自動將分析結果存入 `.rag_cache/` 目錄：

```
.rag_cache/
├── chat_teams_discussion_png_20241215_143022.md
├── image_memory_map_png_20241215_144530.md
└── url_docs_example_com_api_20241215_150012.md
```
...
以下檔案可能包含內部文件內容，**請勿提交到公開 repo**：

- `knowledge.json` - 知識庫（含文件內容與 embedding）
- `.rag_cache/` - VL/URL 分析快取（含原始分析結果）
